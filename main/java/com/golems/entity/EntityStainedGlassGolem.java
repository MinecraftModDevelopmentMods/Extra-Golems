...
public class EntityStainedGlassGolem extends GolemColorizedMultiTextured
{
	...
	{
		super(world, Config.STAINED_GLASS.getBaseAttack(), Blocks.STAINED_GLASS, TEXTURE_BASE, TEXTURE_OVERLAY, ItemDye.DYE_COLORS);
	...
	public void addGolemDrops(List<WeightedItem> dropList, boolean recentlyHit, int lootingLevel)
	{
		...
		this.addDrop(dropList, Blocks.STAINED_GLASS, meta, 0, size > 4 ? 4 : size, 50 + lootingLevel * 10);
		this.addDrop(dropList, Blocks.STAINED_GLASS_PANE, meta, 1, 5 + lootingLevel, 80 + lootingLevel * 10);
	}

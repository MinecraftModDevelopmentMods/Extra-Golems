...
public abstract class GolemDescriptionManager
{
	...
	public List<String> getEntityDescription(GolemBase golem)
	{
		...
		if(showAttack)
		{
			...
			String sAttack = TextFormatting.GRAY + trans("entitytip.attack") + " : " + TextFormatting.WHITE + attack;
			list.add(sAttack);
		}
		...
		if(showSpecial)
		{
			...
			{
				String sIndestructible = TextFormatting.WHITE + "" + TextFormatting.BOLD + trans("entitytip.indestructible");
			...
			{
				String sPotion = TextFormatting.LIGHT_PURPLE + trans("entitytip.grants_self_potion_effects");
			...
			{
				String sPotion = TextFormatting.LIGHT_PURPLE + trans("entitytip.attacks_use_potion_effects");

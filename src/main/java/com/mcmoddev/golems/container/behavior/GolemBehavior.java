...
public abstract class GolemBehavior {
	 ...
	 **/
	protected static final MutableComponent FIRE_DESC = Component.translatable("entitytip.lights_mobs_on_fire").withStyle(ChatFormatting.GOLD);
	/**
	 * The description text for an entity that applies potion effects to itself
	 **/
	protected static final MutableComponent EFFECTS_SELF_DESC = Component.translatable("entitytip.potion_effects_self").withStyle(ChatFormatting.LIGHT_PURPLE);
	/**
	 * The description text for an entity that applies potion effects its enemy
	 **/
	protected static final MutableComponent EFFECTS_ENEMY_DESC = Component.translatable("entitytip.potion_effects_enemy").withStyle(ChatFormatting.LIGHT_PURPLE);

...
public class GolemDescription {
  ...
  /**
   * Creates a new {@link GolemDescription} with a text component that will always
   * be displayed.
   *
   * @param textIn a pre-formatted text component to display
   **/
  ...
  /**
   * Adds the text to the description without any permissions checking. If you
   * want to check the config first, use
  ...
  /**
   * Checks if this tooltip should be added to any list. If an empty key or no key
   * was provided, then this method always returns true.
   *
   * @param container the GolemContainer to query for config permissions

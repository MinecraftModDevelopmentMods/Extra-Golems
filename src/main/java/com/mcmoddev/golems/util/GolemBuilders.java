...
//        .addSpecial(UraniumGolem.AOE, 1.75D, "Poison effects radius")
//        .addSpecial(UraniumGolem.DURATION, 42, "Poison effects length (in ticks)")
//        .addSpecial(UraniumGolem.AMPLIFIER, 2, "Poison effects amplifier")

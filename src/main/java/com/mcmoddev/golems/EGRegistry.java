...
public final class EGRegistry {
	...
	public static final class GolemModifierReg {
		...
		public static final RegistryObject<Codec<AddDescriptionModifier>> ADD_DESCRIPTION = GOLEM_MODIFIER_SERIALIZER.register("add_description", () -> AddDescriptionModifier.CODEC);
		public static final RegistryObject<Codec<RemoveDescriptionModifier>> REMOVE_DESCRIPTION = GOLEM_MODIFIER_SERIALIZER.register("remove_description", () -> RemoveDescriptionModifier.CODEC);

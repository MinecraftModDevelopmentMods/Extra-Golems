...
public class ColoredTextureLayer<T extends GolemBase> extends RenderLayer<T, GolemModel<T>> {
	...
	public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, T entity,
		...
		// validate layers can be rendered
		if (getParentModel().disableLayers()) {
			return;
		}
		...
		layers.get().forEach(layer -> renderTexture(entity, layerModel, layer, poseStack, bufferSource, packedLight, packedOverlay));

...
public class RenderGolem<T extends GolemBase> extends LivingRenderer<T, ModelGolem<T>> {
  ...
  @Override
  protected void applyRotations(final T golem, final float ageInTicks, final float rotationYaw, final float partialTicks) {
  ...
  @Override
  public void doRender(final T golem, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
  ...
  protected void renderDamage(final T golem, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
    ...
    if (index > -1) {
      ...
      // GlStateManager.blendFuncSeparate(GL11.GL_SRC_ALPHA,
      // GL11.GL_ONE_MINUS_SRC_ALPHA, GL11.GL_DST_COLOR, GL11.GL_ONE_MINUS_DST_COLOR);

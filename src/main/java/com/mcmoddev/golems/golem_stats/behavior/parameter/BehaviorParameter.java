...
public abstract class BehaviorParameter {
  ...
  protected static Map<String, String> readStringStringMap(final CompoundNBT tag) {
    final Map<String, String> map = new HashMap<>();
    for(final String key : tag.keySet()) {
	  if(tag.contains(key, Constants.NBT.TAG_ANY_NUMERIC)) {
		map.put(key, String.valueOf(tag.getInt(key)));
	  } else {

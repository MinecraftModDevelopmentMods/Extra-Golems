...
public final class GolemContainer {
  ...
  public static final Codec<GolemContainer> CODEC = RecordCodecBuilder.create(instance -> instance.group(
      ...
      ParticleEffectAmbience.CODEC.optionalFieldOf("particle").forGetter(GolemContainer::getParticle),
  ...
  private GolemContainer(AttributeSettings attributes, SwimMode swimAbility, int glow, int power, boolean hidden,
      SoundEvent sound, Optional<ParticleEffectAmbience> particle, List<ResourcePair> blocksRaw, Map<ResourcePair, Double> healItemsRaw,
  ...
  public Optional<ParticleEffectAmbience> getParticle() { return particle; }

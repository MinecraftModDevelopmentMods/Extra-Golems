...
public final class BookshelfGolem extends GolemBase {
	...
	protected void registerGoals() {
		...
		if(this.getConfigBool(ALLOW_SPECIAL)) {
			final Effect[] goodEffects = { Effects.FIRE_RESISTANCE, Effects.REGENERATION,
					...
					Effects.JUMP_BOOST };
			final Predicate<GolemBase> effectPred = g -> g.getActivePotionEffects().isEmpty() 
					&& g.getEntityWorld().getRandom().nextInt(40) == 0;

...
public final class GolemEntityTypes {
	...
	public static final EntityType ICE = ProxyCommon.build(EntityIceGolem.class, EntityIceGolem::new, GolemNames.ICE_GOLEM, Blocks.PACKED_ICE, Blocks.ICE);
	...
	public static final EntityType MUSHROOM = ProxyCommon.build(EntityMushroomGolem.class, EntityMushroomGolem::new, GolemNames.MUSHROOM_GOLEM, Blocks.RED_MUSHROOM_BLOCK, Blocks.BROWN_MUSHROOM_BLOCK);
	public static final EntityType NETHER_BRICK = ProxyCommon.build(EntityNetherBrickGolem.class, EntityNetherBrickGolem::new, GolemNames.NETHERBRICK_GOLEM, Blocks.NETHER_BRICKS, Blocks.RED_NETHER_BRICKS);

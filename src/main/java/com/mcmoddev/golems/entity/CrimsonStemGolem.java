...
public final class CrimsonStemGolem extends GolemBase {
  ...
  public CrimsonStemGolem(final EntityType<? extends GolemBase> entityType, final Level world) {
  ...
  protected void registerGoals() {
    ...
    final BlockState[] mushrooms = { Blocks.CRIMSON_FUNGUS.defaultBlockState() };

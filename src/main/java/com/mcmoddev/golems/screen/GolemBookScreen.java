...
public class GolemBookScreen extends Screen {
  ...
  protected static final ITextComponent INTRO_PAGE = new TranslationTextComponent("golembook.intro1")
		  .appendString("\n").appendSibling(new TranslationTextComponent("golembook.intro2"));
  ...
  protected static final ITextComponent BUILD_GOLEM_PAGE = new TranslationTextComponent("golembook.build_golem.howto1").appendString(" ")
      .appendSibling(new TranslationTextComponent("golembook.build_golem.howto2")).appendString("\n\n")
      .appendSibling(new TranslationTextComponent("golembook.build_golem.howto3", new TranslationTextComponent("block.golems.golem_head")));
  ...
  protected static final ITextComponent BUILD_HEAD_PAGE = new StringTextComponent("\n\n\n\n")
      .appendSibling(new TranslationTextComponent("golembook.recipe_head.recipe", BUILD_HEAD_TITLE, 
          new TranslationTextComponent("item.golems.golem_paper"), new TranslationTextComponent("block.minecraft.pumpkin")));
  ...
  protected static final ITextComponent BUILD_SPELL_PAGE = new StringTextComponent("\n\n\n\n")
      .appendSibling(new TranslationTextComponent("golembook.recipe_spell.recipe", BUILD_SPELL_TITLE, 
          new TranslationTextComponent("item.minecraft.paper"), new TranslationTextComponent("item.minecraft.feather"),
          new TranslationTextComponent("item.minecraft.ink_sac"), new TranslationTextComponent("item.minecraft.redstone")));
  ...
  public GolemBookScreen(PlayerEntity playerIn, ItemStack itemIn) {
    super(EGRegistry.GOLEM_BOOK.getName());
  ...
  public void init() {
    ...
    this.buttonPreviousPage = this.addButton(new GolemBookScreen.NextPageButton(this, arrowX + ARROW_WIDTH, arrowY, false));
    this.buttonNextPage = this.addButton(new GolemBookScreen.NextPageButton(this, arrowX + BOOK_WIDTH - ARROW_WIDTH * 2, arrowY, true));
    ...
    this.buttonBlockLeft = this.addButton(new GolemBookScreen.BlockButton(this, new Block[] {}, blockX, blockY, GOLEM_BLOCK_SCALE));
    blockX = (this.width / 2) + MARGIN;
    this.buttonBlockRight = this.addButton(new GolemBookScreen.BlockButton(this, new Block[] {}, blockX, blockY, GOLEM_BLOCK_SCALE));
  ...
  private void drawBasicPage(final MatrixStack matrix, int cornerX, int cornerY, 
      ITextComponent title, ITextComponent body) {
  ...
  private void drawTableOfContents(final MatrixStack matrix, final int cornerX, final int cornerY, final ITextComponent title) {
    // use this to draw the title
    drawBasicPage(matrix, cornerX, cornerY, title, StringTextComponent.EMPTY);
  ...
  protected static class BlockButton extends Button {
    ...
    public BlockButton(GolemBookScreen guiIn, Block[] blockValues, int x, int y, float scaleIn) {
      super(x, y, (int) (scaleIn * 16.0F), (int) (scaleIn * 16.0F), StringTextComponent.EMPTY, b -> {
  ...
  protected static class GolemEntryButton extends Button {
    ...
    public GolemEntryButton(final GolemBookScreen guiIn, final GolemBookEntry entryIn, final int x, final int y) {
      super(x, y, ENTRY_W, ENTRY_H, StringTextComponent.EMPTY, b -> {
      });
      this.gui = guiIn;
      this.entry = entryIn;
    }
  ...
  protected static class NextPageButton extends Button {
    ...
    public NextPageButton(GolemBookScreen guiBook, int x, int y, boolean isForwardIn) {
      super(x, y, ARROW_WIDTH, ARROW_HEIGHT, StringTextComponent.EMPTY, b -> {
      });
      this.gui = guiBook;
    ...
    public void renderWidget(final MatrixStack matrix, int mouseX, int mouseY, float partialTicks) {
      if (this.visible) {
		...
		RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        gui.getMinecraft().getTextureManager().bindTexture(GolemBookScreen.TEXTURE);

 ...
 * count as 'water' you must call {@link #setWaterPredicate(Predicate)} and
 * {@link #initAffectedBlockList(int)}, in that order. You can 'add' your liquid
 * to the current predicate by passing

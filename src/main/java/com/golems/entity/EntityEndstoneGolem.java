...
public class EntityEndstoneGolem extends GolemBase {
	 ...
	 **/
	public EntityEndstoneGolem(World world, float attack, ItemStack pick, double teleportRange,
			boolean teleportingAllowed, boolean hurtByWater, boolean ambientParticles) {
	 ...
	 **/
	public EntityEndstoneGolem(World world, float attack, double teleportRange,
			boolean teleportingAllowed, boolean hurtByWater, boolean ambientParticles) {
	...
	protected boolean teleportToEntity(Entity p_70816_1_) {
		Vec3d vec3d = new Vec3d(this.posX - p_70816_1_.posX,
				this.getEntityBoundingBox().minY + (double) (this.height / 2.0F) - p_70816_1_.posY
	...
	private boolean teleportTo(double x, double y, double z) {
		...
		boolean flag = this.attemptTeleport(event.getTargetX(), event.getTargetY(),
				event.getTargetZ());

...
public final class EntityWoolGolem extends GolemMultiTextured {
  ...
  public static final String[] coloredWoolTypes = { "black", "orange", "magenta", "light_blue", "yellow", "lime",
      "pink", "gray", "silver", "cyan", "purple", "blue", "brown", "green", "red", "white" };
  ...
  public void onBuilt(IBlockState body, IBlockState legs, IBlockState arm1, IBlockState arm2) {
    ...
    final int meta = body.getBlock().getMetaFromState(body) % this.getTextureArray().length;
  ...
  private static String getRainbowString(final String stringIn, final long timeIn) {
    ...
    TextFormatting[] colorChar = { TextFormatting.RED, TextFormatting.GOLD, TextFormatting.YELLOW, TextFormatting.GREEN,
        TextFormatting.AQUA, TextFormatting.BLUE, TextFormatting.LIGHT_PURPLE, TextFormatting.DARK_PURPLE };

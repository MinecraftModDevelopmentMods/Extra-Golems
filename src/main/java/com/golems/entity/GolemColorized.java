...
public abstract class GolemColorized extends GolemBase {
   ...
   *                 transparent.
   **/
  public GolemColorized(final World world, final long initial, @Nullable final ResourceLocation rBase,
      @Nullable final ResourceLocation rOverlay) {
    super(world);
  ...
  /**
   * Updates {@link #color} as well as calculates the RGBA components of that
   * color.
   **/
  ...
  /**
   * Whether {@link overlay} should be rendered as transparent. This is not called
   * for rendering {@link base}, only for rendering the colorized layer.
   **/

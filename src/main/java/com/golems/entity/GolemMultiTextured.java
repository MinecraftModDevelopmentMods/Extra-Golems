...
public abstract class GolemMultiTextured extends GolemBase
{
	...
	/** ResourceLocation array of textures to loop through when the player interacts with this golem. Max size is 128 **/
	 ...
	 * If <b>updateInstantly</b> is true, call {@link #setTextureType(ResourceLocation)}
	 * based on {@link #getTextureFromArray(int)} and {@link #getTextureNum()}
	 **/
